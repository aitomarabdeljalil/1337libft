...
SRC_BN	:= ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c ft_lstdelone.c ft_lstiter.c ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c
OBJ		:= $(patsubst %.c, %.o, $(SRC))
OBJ_BN 	:= $(patsubst %.c, %.o, $(SRC_BN))
